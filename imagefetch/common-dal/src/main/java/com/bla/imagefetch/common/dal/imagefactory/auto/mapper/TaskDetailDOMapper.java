...
public interface TaskDetailDOMapper{
     ...
     * descSql =  SELECT * FROM task_detail WHERE INSTANCE_NAME = #{instanceName,jdbcType=VARCHAR} AND STATUS = #{status,jdbcType=VARCHAR} 
     * @param status status
     * @param instanceName instanceName
     * @return List<TaskDetailDO>
     */
    List<TaskDetailDO> queryByInstanceNameAndStatus(@Param("status")String status,@Param("instanceName")String instanceName);
}
